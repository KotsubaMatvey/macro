...
export const surfaces = {
 ...
 shell: 'grid min-h-screen xl:grid-cols-[268px_minmax(0,1fr)]',
 sidebar: 'sticky top-0 flex h-screen flex-col border-r border-[var(--line)] bg-[linear-gradient(180deg,rgba(9,13,19,0.98),rgba(8,12,18,0.96))] px-3 py-3',
 ...
 navItem: 'group rounded-[12px] border px-3 py-2.5 transition',
 navItemActive: 'border-amber-500/25 bg-[linear-gradient(90deg,rgba(209,138,47,0.12),rgba(255,255,255,0.012))] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]',
