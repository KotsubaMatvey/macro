...
export default async function MarketBiasPage() { 
 ...
 return h(PageShell, { title: 'Market Bias', subtitle: 'Factor influence surface with explicit live and degraded labeling across macro and market inputs.', active: 'market-bias', mode: payload.summary.freshness.mode === 'live' ? 'live' : 'fallback' }, h('div', { className: 'space-y-5' }, [ 
